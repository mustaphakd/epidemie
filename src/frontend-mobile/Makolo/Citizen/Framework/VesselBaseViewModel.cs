...
{
    public abstract class VesselBaseViewModel<AVM,  T> : BaseStateAwareViewModel<Citizen.Core.ViewStates>
        ...
        where AVM: ActionableBaseViewModel<AVM, T>
    {
        ...
        private async Task CancelAsync()
        {
            ...
            await App.NavigateBackAsync();  // not regiested Xamarin.Forms.Shell.Current.GoToAsync(Core.Routes.Home, false);
        }
