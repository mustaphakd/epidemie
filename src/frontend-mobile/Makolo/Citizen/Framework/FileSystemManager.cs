...
namespace Citizen.Framework.Files
{
    /// <summary>
    ...
    public static class FileSystemManager
    {
        ...
        public async static Task WriteLocalFileTextAsync(string s, string name, string path = null)
        {
            ...
            //{
            using (StreamWriter sw = new StreamWriter(File.Open(fullPath, FileMode.OpenOrCreate, FileAccess.Write, FileShare.Read)))
            {
        ...
        public static void EnsureFileCreated(string file)
        {
        ...
        public async static Task WriteLocalSetting<T>(string key, T option)
        {
            ...
            try
            {
                ...
                settings = Newtonsoft.Json.JsonConvert.DeserializeObject<Dictionary<string, string>>(json);
